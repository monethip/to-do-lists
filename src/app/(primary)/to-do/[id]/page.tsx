...
const ToDoList = () => {
    ...
    return (
        <div className="max-w-screen-xl mx-auto p-4 ">
            {loading ? <Loading /> : <> <div className="flex gap-2 cursor-pointer mt-4 mb-10" onClick={() => router.back()}><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="black" d="M9.308 17.308L4 12l5.308-5.308l.707.708l-4.1 4.1H20v1H5.915l4.1 4.1z" /></svg>Back</div>
